...
<?php
    ...
    while($dataRow=mysqli_fetch_assoc($result)){
        $country = $dataRow['country_name'];
        $country_code = $dataRow['country_code'];
} ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form action="edit-countryPro" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="txt_country" required=""
