...
<?php
$id =  $_GET['id'];
$sql ="SELECT * FROM sub_category_tbl WHERE sub_cat_id = '$id'";
$result = mysqli_query($connection,$sql);
while($dataRow=mysqli_fetch_assoc($result)){
    $subcategory = $dataRow['subcat_name'];
} ?>
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> EDIT SUB CATEGORY</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form action="edit-subcategoryPro" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label">ID</label>
                                <input class="form-control" type="text" name="txt_sub_id" readonly="" required=""
                                       value="<?php echo $id; ?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Sub category Name</label>
                                <input class="form-control" type="text" name="txt_subcategory" required=""
                    ...
                    <div class="tile-footer">
                        ...
                        <a class="btn btn-secondary" href="list-subcategory.php">
